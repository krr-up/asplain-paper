...
\begin{definition}[Classical Model Mask]
  Given a program graph $\pg{P} = \langle V_c \cup V_d \cup V_a, E_{+}, E_{-} \rangle$,
...
\begin{definition}[(minimal) Model Mask]
  Given a program graph $\pg{P} = \langle V_c \cup V_d \cup V_a, E_{+}, E_{-} \rangle$,
  we say a valid \emph{classical model mask} $CM = \langle V, E_{+}, E_{-} \rangle$ of $\pg{P}$
...
\begin{definition}[Model Subgraph Computed]
  Given a program graph $\pg{P} = \langle V_c \cup V_d \cup V_a, E_{+} \cup E_{-} \rangle$,
