...
\begin{itemize}
  ...
  %
  \item However, other notions as for instance unsatisfiable-cores~?
  \comment{TODO: find best reference for usnat cores}
...
\begin{definition}[Valid Foil]\label{def:valid-foil}
  ...
  \begin{itemize}
    ...
    \textbf{Brais:} no, we add rules to form $P_f$, and this rules will have its own label in $P_f$ }
    %
    \item and
    %
