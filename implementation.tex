...
\comment{TODO SUSANA: Improve image with numbers. Reference workflow in text below. Improve UNSAT.}
...
\begin{itemize}
      ...
      \comment{TODO SUSANA: Motivate simplification.}
...
\comment{TODO SUSANA: Rephrase using the inteactivity in the end and talk more about the concept of assumptions}
\begin{itemize}
...
\begin{itemize}
      ...
      \comment{TODO SON: Can we aregue something here about it mapping back to a single level?}
...
\comment{TODO SUSANA: Add implementation for a single explanation}
