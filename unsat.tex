...
\comment{Here we migth want a different definition of contrastive explanation for unsat programs without the reference model.}

\comment{A preference function that does the same as UNSAT CORE subset minimization might be a good example here, if it is even possible.
